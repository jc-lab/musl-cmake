...
MUSL_EXPORT int sched_setaffinity(pid_t tid, size_t size, const cpu_set_t *set)
{
	return syscall(SYS_sched_setaffinity, tid, size, set);
}

MUSL_EXPORT int pthread_setaffinity_np(pthread_t td, size_t size, const cpu_set_t *set)
{
...
MUSL_EXPORT int sched_getaffinity(pid_t tid, size_t size, cpu_set_t *set)
{
	return __syscall_ret(do_getaffinity(tid, size, set));
}

MUSL_EXPORT int pthread_getaffinity_np(pthread_t td, size_t size, cpu_set_t *set)
{
